...
export default function AskQuestion() {
  ...
  const { addQuestion } = useCommunityStore();
  ...
  return (
    <CommunityLayout 
      ...
      subtitle="Get help from the community by sharing your challenge clearly."
    >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 max-w-4xl">
          <label className="block space-y-2">
            <div className="flex items-center justify-between text-sm font-medium text-foreground">
              <span>Title</span>
              {errors.title && <span className="text-destructive text-xs font-normal">{errors.title.message}</span>}
            </div>
            <input
              type="text"
          ...
          <label className="block space-y-2">
            <div className="flex items-center justify-between text-sm font-medium text-foreground">
              <span>Body</span>
              {errors.body && <span className="text-destructive text-xs font-normal">{errors.body.message}</span>}
            </div>
            <EditorMarkdown
              value={body}
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-sm font-medium text-foreground">
              <span>Tags</span>
              <span className="text-muted-foreground text-xs font-normal">Add up to 5 tags</span>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-border bg-card p-4 text-sm text-muted-foreground">
            ...
            <button
              ...
              className="rounded-md bg-primary px-6 py-2 text-sm font-semibold text-primary-foreground shadow transition hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-70"
            >
